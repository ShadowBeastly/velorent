...
import { Plus, Loader2, Edit, Mail, Phone, List, LayoutGrid, MoreHorizontal, MapPin, Download, Users } from "lucide-react";
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Kunden</h2>
            </div>
                    ...
                    <div className="overflow-x-auto">
                        ...
                        {filtered.length === 0 && (
                            <div className={`p-12 text-center ${darkMode ? "text-slate-500" : "text-slate-400"}`}>
                                ...
                                <p className="text-lg font-medium">Noch keine Kunden angelegt</p>
                                <button
                                    onClick={() => { setEditCustomer(null); setShowModal(true); }}
